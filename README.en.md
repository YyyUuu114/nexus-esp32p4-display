...
This is the stable desktop branch. The current version is **1.1.0**. Matching firmware source is on [`firmware-stable`](https://github.com/YyyUuu114/nexus-esp32p4-display/tree/firmware-stable); development takes place on [`desktop-dev`](https://github.com/YyyUuu114/nexus-esp32p4-display/tree/desktop-dev) and [`firmware-dev`](https://github.com/YyyUuu114/nexus-esp32p4-display/tree/firmware-dev).

## Quick start

1. Download `NEXUS-Display-Windows-x64.zip` from the [v1.1.0 release](https://github.com/YyyUuu114/nexus-esp32p4-display/releases/tag/v1.1.0).
