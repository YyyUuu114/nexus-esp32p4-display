...
本分支是桌面端开发分支，当前版本为 **2.1.1**。它引入双向设备握手和受保护更新链，线协议升级为 2.0，分类为 `coordinated-breaking`；必须同时使用固件 v2.1.1。正式桌面端仍位于 [`desktop-stable`](https://github.com/YyyUuu114/nexus-esp32p4-display/tree/desktop-stable)。
